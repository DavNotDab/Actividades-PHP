...
<body>
    ...
    <h1>Intervalo de impares con GET</h1>
    ...
    if (empty($_GET["n1"]) || empty($_GET["n2"]))
        ...
        if (!is_numeric($n1) || !is_numeric($n2))
            ...
            elseif (($n2 - $n1 == 2) && ($n1 % 2 == 0))
                echo "<h2>No hay ningún número impar en medio</h2>";
            else {
                echo "<h2>El intevalo de impares entre los dos números es:</h2>";
                while ($n1 < $n2-1) {
                    $n1++; 
